...
class Create(Resource):
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            ApiCreateArgs.SECRET.value,
            type=str,
            required=True,
            help=HELP_CREATE["secret"],
        )
        self.parser.add_argument(
            ApiCreateArgs.PASSPHRASE.value,
            type=str,
            required=True,
            help=HELP_CREATE["passphrase"],
        )
        self.parser.add_argument(
            ApiCreateArgs.DAYS.value, type=int, required=True, help=HELP_CREATE["days"]
        )
        super().__init__()
    ...
    def post(self):
        ...
        response = create_secret(args["passphrase"], args["secret"], args["days"])
...
class Read(Resource):
    ...
    def __init__(self):
        self.parser = reqparse.RequestParser(bundle_errors=True)
        self.parser.add_argument(
            ApiReadArgs.SLUG.value, type=str, required=True, help=HELP_READ["slug"]
        )
        self.parser.add_argument(
            ApiReadArgs.PASSPHRASE.value,
            type=str,
            required=True,
